...
namespace Asn1PKCSTest.Decoder
{
    ...
    public class PKCS8DERDecoderTest
    {
        ...
        public void DecodePublicKeyTest_384bit()
        {
            ...
            expectedRsaParams.Modulus = new byte[] { 0xB0, 0xDB, 0x23, 0xC3, 0x58, 0xBD, 0x7A, 0x2C, 0x34, 0xDF, 0x52, 0x63, 0x40, 0xB3, 0x0A, 0xAF, 0x1C, 0xF1, 0x9B, 0xF6, 0x50, 0x9A, 0x52, 0xB7, 0x73, 0x3D, 0xD0, 0xB7, 0xBE, 0x9C, 0xA6, 0x9A, 0x4F, 0x2C, 0xA9, 0xCC, 0xE2, 0x96, 0x14, 0xE4, 0x2F, 0x35, 0xAA, 0x03, 0x34, 0x56, 0xD6, 0xD9 };
        ...
        public void DecodePrivateKeyTest_384bit()
        {
            ...
            expectedRsaParams.P = new byte[] { 0xE2, 0x62, 0xB3, 0xE3, 0x51, 0x04, 0xA9, 0x19, 0xD4, 0xEF, 0x3B, 0xFB, 0x79, 0xF2, 0x91, 0xC7, 0x4F, 0x61, 0xB0, 0x19, 0x6E, 0xF6, 0x7A, 0x69 };
            expectedRsaParams.Q = new byte[] { 0xC7, 0xFD, 0xC5, 0x31, 0xA7, 0x1E, 0x93, 0x65, 0x9F, 0x86, 0xF0, 0xF1, 0x5E, 0xA1, 0x06, 0x34, 0x9E, 0x77, 0x3C, 0x0D, 0x69, 0xA9, 0x8A, 0xF1 };
