...
namespace Asn1PKCSTest.Decoder
{
    ...
    public class PKCS1DERDecoderTest
    {
        ...
        public void DecodePublicKeyTest_512bit()
        {
            ...
            expectedRsaParams.Modulus = new byte[] { 0xCE, 0x9D, 0xCC, 0x96, 0x9C, 0xC5, 0xC9, 0x9A, 0x79, 0x1C, 0xE5, 0xBA, 0xA6, 0x46, 0xFE, 0x7E, 0xC7, 0xF2, 0x8A, 0x7A, 0xCE, 0x6E, 0x04, 0x79, 0x28, 0x8B, 0x5A, 0xF2, 0xC0, 0x22, 0xE0, 0xE1, 0x82, 0x75, 0x77, 0xE0, 0x6F, 0x5D, 0x22, 0x5B, 0x43, 0xE6, 0xD0, 0x74, 0x45, 0x9C, 0xA6, 0x8A, 0xCD, 0x79, 0x8A, 0x3C, 0x85, 0x82, 0xC8, 0x40, 0x76, 0x54, 0xCF, 0x54, 0x8B, 0x89, 0x92, 0x99 };
        ...
        public void DecodePrivateKeyTest_512bit()
        {
            ...
            expectedRsaParams.P = new byte[] { 0xE8, 0x97, 0xFC, 0xE0, 0xED, 0xA1, 0xA0, 0xF6, 0xC2, 0x35, 0xB8, 0xBA, 0x2D, 0x78, 0x93, 0xE5, 0x74, 0xFC, 0xE1, 0xAD, 0x32, 0xDC, 0xCB, 0x56, 0xB8, 0xE7, 0x57, 0x1D, 0x0E, 0x6C, 0x46, 0x41 };
            expectedRsaParams.Q = new byte[] { 0xE3, 0x68, 0x97, 0x75, 0x87, 0x71, 0xF4, 0x20, 0x2D, 0x5F, 0x1B, 0x9B, 0xFD, 0x0D, 0x9A, 0x55, 0x56, 0x2F, 0xE4, 0xC8, 0x47, 0xAE, 0xB4, 0x17, 0xF1, 0x82, 0xDE, 0x9E, 0x62, 0x97, 0xA6, 0x59 };
