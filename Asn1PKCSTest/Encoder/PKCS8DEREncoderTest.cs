...
namespace Asn1PKCSTest.Encoder
{
    ...
    public class PKCS8DEREncoderTest
    {
        ...
        {
            byte[] modulus = new byte[] { 0x00, 0xBE, 0x7D, 0xF2, 0xE9, 0x01, 0xCA, 0x41, 0x62, 0x6F, 0x1B, 0x88, 0x8A, 0xB9, 0x65, 0x95, 0x16, 0x25, 0x69, 0xDF, 0xC9, 0xB2, 0x48, 0x3D, 0x96, 0x65, 0x75, 0x13, 0x4D, 0x70, 0x52, 0x19, 0xF0, 0x52, 0xEC, 0xF4, 0x6E, 0xDA, 0x02, 0x76, 0x2C, 0x08, 0xB5, 0xB3, 0x8F, 0x5D, 0x76, 0x99, 0x1D };
        ...
        {
            byte[] modulus = new byte[] { 0x00, 0xB9, 0x46, 0x37, 0x1D, 0x24, 0x4D, 0xD3, 0xC0, 0x8D, 0x29, 0xE4, 0x84, 0x7D, 0x17, 0xC9, 0x17, 0xE4, 0x2A, 0xBB, 0x0F, 0xEE, 0x20, 0x98, 0x0A, 0xE0, 0x9A, 0xF7, 0xBB, 0xDC, 0xDC, 0x96, 0x47, 0x36, 0xDC, 0x99, 0x8C, 0x15, 0x8F, 0x32, 0xFC, 0x76, 0xA7, 0xE8, 0x96, 0xEF, 0xC0, 0x5E, 0xF5 };
        ...
        {
            RSAParameters rsaParams = new RSAParameters();
            rsaParams.Modulus = new byte[] { 0x00, 0xEA, 0x41, 0x8B, 0x17, 0x64, 0xFB, 0x35, 0x5C, 0x89, 0xB7, 0xFD, 0x3B, 0x11, 0xE0, 0x2A, 0x76, 0xDE, 0xE4, 0x1E, 0xA8, 0x1E, 0xA0, 0x0D, 0x77, 0x96, 0x61, 0xB7, 0x35, 0x3F, 0xC3, 0x68, 0xFB, 0x2B, 0x9C, 0x43, 0x3E, 0x4C, 0x87, 0x9B, 0xD6, 0xA3, 0x76, 0x1D, 0xF1, 0xCA, 0x0A, 0x69, 0x1F };
            ...
            rsaParams.P = new byte[] { 0x00, 0xFC, 0xD1, 0x5C, 0x3C, 0x18, 0x99, 0x51, 0x5A, 0xB0, 0x25, 0xCA, 0x38, 0xE9, 0xBF, 0xF4, 0x1E, 0x1F, 0x63, 0x6A, 0x15, 0x55, 0x8D, 0x21, 0x53 };
            rsaParams.Q = new byte[] { 0x00, 0xED, 0x34, 0x5F, 0x5C, 0x7B, 0x10, 0x70, 0x2B, 0xA0, 0xD7, 0x2B, 0xEC, 0xDE, 0x0F, 0xB6, 0x54, 0x4F, 0x0D, 0x7C, 0x0E, 0x99, 0x37, 0x63, 0x85 };
            ...
            rsaParams.InverseQ = new byte[] { 0x00, 0xBB, 0x62, 0xB3, 0x54, 0xA4, 0x63, 0xED, 0x67, 0xAC, 0x9D, 0x95, 0xDF, 0xD9, 0x98, 0xBC, 0x37, 0x65, 0x20, 0xA2, 0xDD, 0x76, 0x58, 0x10, 0x9F };
